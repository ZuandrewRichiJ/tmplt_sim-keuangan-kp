              ...
              ?>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <a href="query.php?barang_del=<?= $data['id_barang']; ?>" type="button" class="btn btn-danger text-xs btn-sm" onclick="return confirm('Apakah anda yakin ingin menghapus data ini : \n<?= $data['nama_barang']; ?>')"><i class="fa fa-trash"></i> Hapus</a>
                  </td>
                </tr>
